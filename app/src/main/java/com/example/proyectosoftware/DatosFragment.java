...
public class DatosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_datos, container, false);

        Button bnt_3= vista.findViewById(R.id.button12);
        bnt_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                findNavController(v).navigate(R.id.action_datosFragment_to_listaEstudiantesFragment);
            }
        });
        return vista;
    }
